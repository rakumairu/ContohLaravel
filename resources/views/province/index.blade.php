...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">Province Options</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Province Options</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
          ...
          <form role="form" id="form_add">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="description" class="form-control form-control-sm"  id="description" maxlength="100">
              </div>
            </div>
          </form>
        </div>
          ...
          <form role="form" id="form_update">
            ...
            <div class="card-body">
              <div class="form-group">
                ...
                <input type="text" name="description" id="edit_description" class="form-control form-control-sm" placeholder="Description" maxlength="100">
              </div>
            </div>
          </form>
        </div>
